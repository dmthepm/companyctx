...
- Artifact id: `brief-6a24fd6cb2dc` (opaque, stable across regeneration)
...
Site identity is rewritten to the slug `cary-hormone-02` (display name "Cary Hormone 02").
...
cary-hormone-02.example --mock --json` and diffs the output against `expected.json`
