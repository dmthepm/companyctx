...
- Artifact id: `brief-b2f68716f981` (opaque, stable across regeneration)
...
Site identity is rewritten to the slug `birmingham-iv-04` (display name "Birmingham Iv 04").
...
birmingham-iv-04.example --mock --json` and diffs the output against `expected.json`
