...
- Artifact id: `brief-28a610bddf4e` (opaque, stable across regeneration)
...
Site identity is rewritten to the slug `charleston-medspa-05` (display name "Charleston Medspa 05").
...
charleston-medspa-05.example --mock --json` and diffs the output against `expected.json`
