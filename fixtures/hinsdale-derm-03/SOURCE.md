...
- Artifact id: `brief-29cc51c3333a` (opaque, stable across regeneration)
...
Site identity is rewritten to the slug `hinsdale-derm-03` (display name "Hinsdale Derm 03").
...
hinsdale-derm-03.example --mock --json` and diffs the output against `expected.json`
